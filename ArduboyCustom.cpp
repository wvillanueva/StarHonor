...
void ArduboyCustom::start() // deprecated
{
  begin();
}
...
void ArduboyCustom::setFrameRate(uint8_t rate)
{
  frameRate = rate;
  eachFrameMillis = 1000/rate;
}

bool ArduboyCustom::everyXFrames(uint8_t frames)
{
  return frameCount % frames == 0;
}

bool ArduboyCustom::nextFrame()
{
  long now = millis();
  uint8_t remaining;
...
int ArduboyCustom::cpuLoad()
{
  return lastFrameDurationMs*100 / eachFrameMillis;
}

void ArduboyCustom::initRandomSeed()
{
...
uint16_t ArduboyCustom::rawADC(byte adc_bits)
{
  ADMUX = adc_bits;
...
void ArduboyCustom::clearDisplay() // deprecated
{
  clear();
}

void ArduboyCustom::clear()
{
  fillScreen(BLACK);
}

void ArduboyCustom::drawPixel(int x, int y, uint8_t color)
{
...
uint8_t ArduboyCustom::getPixel(uint8_t x, uint8_t y)
{
  uint8_t row = y / 8;
...
void ArduboyCustom::drawCircle(int16_t x0, int16_t y0, uint8_t r, uint8_t color)
{
  int16_t f = 1 - r;
  int16_t ddF_x = 1;
  int16_t ddF_y = -2 * r;
...
void ArduboyCustom::drawCircleHelper
...
void ArduboyCustom::fillCircle(int16_t x0, int16_t y0, uint8_t r, uint8_t color)
{
  drawFastVLine(x0, y0-r, 2*r+1, color);
  fillCircleHelper(x0, y0, r, 3, 0, color);
}

void ArduboyCustom::fillCircleHelper
...
void ArduboyCustom::drawFastVLine
...
void ArduboyCustom::drawFastHLine
...
void ArduboyCustom::fillScreen(uint8_t color)
{
  // C version :
  //
...
void ArduboyCustom::drawRoundRect
...
void ArduboyCustom::fillRoundRect
(int16_t x, int16_t y, uint8_t w, uint8_t h, uint8_t r, uint8_t color)
{
  // smarter version
...
void ArduboyCustom::drawTriangle
...
void ArduboyCustom::fillTriangle
(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t color)
{
...
void ArduboyCustom::drawSlowXYBitmap
...
unsigned char* ArduboyCustom::getBuffer()
{
  return sBuffer;
}

boolean ArduboyCustom::pressed(uint8_t buttons)
{
  return (buttonsState() & buttons) == buttons;
}

boolean ArduboyCustom::notPressed(uint8_t buttons)
{
  return (buttonsState() & buttons) == 0;
}

void ArduboyCustom::swap(int16_t& a, int16_t& b)
{
  int temp = a;
  a = b;
  b = temp;
